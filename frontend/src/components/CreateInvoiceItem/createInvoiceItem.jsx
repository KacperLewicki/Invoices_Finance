...
return(
    ...
    <input name = "quantity" className='invoiceFormsItems' type = "number" value = {quantity} onChange = {(e) => this.setState({quantity: e.target.value})} placeholder = 'Quantity' />
    <input name = "vatItem" className='invoiceFormsItems' type = "number" value = {vatItem} onChange ={(e) => this.setState({vatItem: e.target.value})} placeholder ='VAT' />
    <input name = "nettoItem" className='invoiceFormsItems' type = "number" value = {nettoItem} onChange = {(e) => this.setState({nettoItem: e.target.value})} placeholder='Netto' />
    <input name = "bruttoItem" className='invoiceFormsItems' type = "number" value = {bruttoItem} onChange = {(e) => this.setState({bruttoItem: e.target.value})} placeholder='brutto' />
